...
public class ServiceOrderRepositoryImpl implements ServiceOrderRepository {
        ...
        public ServiceOrder save(ServiceOrder serviceOrder) {
                ...
                Set<ServiceOrderVehicleServiceEntity> services = serviceOrder.getServices().stream()
                                .map(service -> {
                                        var vehicleServiceJpa = entityManager
                                                        .getReference(VehicleServiceJpaEntity.class, service.getId());
                ...
                var entity = serviceOrderMapper.toServiceOrderEntity(serviceOrder, customer, vehicle, employee,
                                services);
