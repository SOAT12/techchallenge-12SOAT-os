...
import com.fiap.soat12.os.cleanarch.infrastructure.web.controller.ToolCategoryController;
...
public class ToolCategoryApi {
    ...
    @Operation(summary = "Cria uma nova categoria de ferramenta", description = "Cria uma nova categoria de ferramenta com base nos dados fornecidos.")
    @ApiResponse(responseCode = "201", description = "Categoria criada com sucesso")
    @ApiResponse(responseCode = "400", description = "Requisição inválida")
    @PostMapping
    public ResponseEntity<ToolCategoryResponseDTO> createToolCategory(
            @Valid @RequestBody ToolCategoryRequestDTO requestDTO) {
        try {
    ...
    @Operation(summary = "Obtém uma categoria de ferramenta pelo ID", description = "Retorna uma categoria de ferramenta específica pelo seu ID.")
    ...
    @Operation(summary = "Lista todas as categorias de ferramentas", description = "Retorna uma lista de todas as categorias de ferramentas cadastradas.")
    ...
    @Operation(summary = "Lista todas as categorias de ferramentas ativas", description = "Retorna uma lista de todas as categorias de ferramentas cadastradas e com status ativo")
    ...
    @Operation(summary = "Atualiza uma categoria de ferramenta existente", description = "Atualiza os dados de uma categoria de ferramenta pelo seu ID.")
    @ApiResponse(responseCode = "200", description = "Categoria atualizada com sucesso")
    @ApiResponse(responseCode = "400", description = "Requisição inválida")
    @ApiResponse(responseCode = "404", description = "Categoria não encontrada")
    @PutMapping("/{id}")
    public ToolCategoryResponseDTO updateToolCategory(@PathVariable UUID id,
            @Valid @RequestBody ToolCategoryRequestDTO requestDTO) {
        try {
    ...
    @Operation(summary = "Deleta uma categoria de ferramenta", description = "Remove uma categoria de ferramenta pelo seu ID.")
    ...
    @Operation(summary = "Reativa uma categoria de ferramenta", description = "Marca uma categoria de ferramenta como ativa pelo seu ID.")
