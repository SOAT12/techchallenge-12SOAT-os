    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/employees/{id}/change-password")
                        .hasAnyRole(AUTHORIZED_ROLES)
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/employee-functions/{id}/activate")
                        .hasAnyRole(AUTHORIZED_ROLES)
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/service-orders/{id}/diagnose")
                        .hasAnyRole(AUTHORIZED_ROLES)
                        .requestMatchers(HttpMethod.PATCH, "/api/service-orders/{id}/wait-for-approval")
                        .hasAnyRole(AUTHORIZED_ROLES)
                        .requestMatchers(HttpMethod.PATCH, "/api/service-orders/{id}/approve")
                        .hasAnyRole(AUTHORIZED_ROLES)
                        .requestMatchers(HttpMethod.PATCH, "/api/service-orders/{id}/reject")
                        .hasAnyRole(AUTHORIZED_ROLES)
                        .requestMatchers(HttpMethod.PATCH, "/api/service-orders/{id}/finish")
                        .hasAnyRole(AUTHORIZED_ROLES)
                        .requestMatchers(HttpMethod.PATCH, "/api/service-orders/{id}/deliver")
                        .hasAnyRole(AUTHORIZED_ROLES)
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/vehicle-services/{id}/deactivate")
                        .hasAnyRole(AUTHORIZED_ROLES)
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/vehicle/plate/{licensePlate}")
                        .hasAnyRole(AUTHORIZED_ROLES)
